...
textFileName2 = 'MovieSubtilteTestOutput.srt'

ListOInputText = ReadTextFileIntoList.ReadTextFileIntoList(textFileLocation=textFileLocation,textFileName=textFileName)
...
# ''':
    if TextToSend == '':
        ListOfTranslatedText.append(TextToSend)

    elif TextisInt:

        if TextToSend2 == TextToSend:
            pass
